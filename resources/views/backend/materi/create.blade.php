...
<x-card title="Materi">
    ...
    <form action="{{ route('manage.materi.store') }}" method="post" class="row" enctype="multipart/form-data">
        @csrf
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                <input type="text" name="judul" id="judul" class="form-control" placeholder="" aria-describedby="helpId" required>
            </div>
            <div class="form-group">
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                <div class="form-control" id="konten" style="height: 300px;"></div>
            </div>
        </div>
